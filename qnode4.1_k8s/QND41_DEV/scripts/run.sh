...
python manage.py collectstatic --settings=qnode41_app.settings.local --noinput 
...
uwsgi --http :9000 --workers 9 --master --enable-threads --module qnode41_app.wsgi  --ini uwsgi_prod.ini
