...
class OrderItemInline(admin.TabularInline):
    ...
    readonly_fields = ['price','quantity','order']
...
class OrderAdmin(admin.ModelAdmin):
    list_display = [ 'full_name', 
                    'emision','vencimiento', 'paid','total_cost',
                   email,whatsapp ]
    list_filter = ['emision','vencimiento','paid', 'created', 'updated']
    date_hierarchy = 'emision'
    readonly_fields = ['first_name','last_name','emision','vencimiento','paid','email','total']
    list_per_page = 10
