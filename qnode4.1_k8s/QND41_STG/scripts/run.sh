...
rm /py/lib/python3.9/site-packages/baton/static/baton/app/dist/baton.min.js
...
python manage.py collectstatic --settings=qnode41_app.settings.stage --noinput 
...
uwsgi --http :9000 --workers 9 --master --enable-threads --module qnode41_app.wsgi  --ini uwsgi_stage.ini
